    ...
    return (
        <>
            ...
            <div className='gamesPlayed'>
                ...
                <span style={{ fontSize: 26, paddingLeft: 94 }}> 41 </span>
            </div>

            <div className='goals'>
                <span style={{ fontSize: 26, fontWeight: 'bold'}}> GOALS </span>
                <span style={{ fontSize: 26, paddingLeft: 204 }}> 34 </span>
            </div>
            ...
            <div className='minutesPlayed'>
                ...
                <span style={{ fontSize: 26, paddingLeft: 59 }}> 3.687' </span>
            </div>
