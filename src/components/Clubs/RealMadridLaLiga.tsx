    ...
    return (
        <>
            ...
            <div className='gamesPlayed'>
                ...
                <span style={{ fontSize: 26, paddingLeft: 80 }}> 292 </span>
            </div>

            <div className='goals'>
                <span style={{ fontSize: 26, fontWeight: 'bold'}}> GOALS </span>
                <span style={{ fontSize: 26, paddingLeft: 190 }}> 311 </span>
            </div>

            <div className='assists'>
                <span style={{ fontSize: 26, fontWeight: 'bold'}}> ASSISTS </span>
                <span style={{ fontSize: 26, paddingLeft: 184 }}> 95 </span>
            </div>
...
export default RealMadridLaLiga;